            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 text-center p-5">
                        ...
                        <p className="subtitle" style={{fontSize: "18px"}}>Get the best Marine Insurance rates and same day delivery from Bimafy.</p>
                    </div>
                </div>
                <div className="row justify-content-end">
                    <div className="col-md-6">
                        ...
                        <p style={{fontSize:"15px",fontWeight:"bold"}}>Advantages of using Bimafy for Marine Insurance</p>
                        <ul>
