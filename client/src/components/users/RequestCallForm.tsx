          ...
          <form action="#" method="POST" className="form-style">
            <div className="form-row">
              ...
              <div className="form-group col-md-6">
                ...
                <select id="topic" name="topic" className="form-control" required>
                  ...
                  <option value="motorcycle_insurance">Motorcycle Insurance</option>
                </select>
              </div>
            </div>
            <div className="form-group text-center">
              <button type="submit" className="btn btn-primary">Send call request</button>
            </div>
          </form>
        </div>
      </div>
