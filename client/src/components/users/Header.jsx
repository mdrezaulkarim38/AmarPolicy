              ...
              <span></span>
                ...
                <div className="main-menu-wrapper">
                    ...
                    <ul className="main-nav">
                        ...
                        <li className="has-submenu">
                            <Link to="/product">Products <i className="fas fa-chevron-down"></i></Link>
                        ...
                        <li className="has-submenu">
                            <Link to="/enrollments">Activate <i className="fas fa-chevron-down"></i></Link>
                            <ul className="submenu">
                                <li><Link to="/speedoz">Origine Helmets by Speedoz</Link></li>
                                <li><Link to="/mt-speedoz">MT Helmets by Speedoz</Link></li>
                                <li><Link to="/gearx">GearX Bangladesh</Link></li>
                                <li><Link to="/ar-helmets">AR Helmets</Link></li>
                                <li><Link to="/freedconn">FreedConn Bangladesh</Link></li>
                            </ul>
                        </li>
                        <li>
                            <Link to="/login" rel="noopener noreferrer">Claims</Link>
                        </li>
                        <li className="has-submenu">
                            <Link to="#">Support <i className="fas fa-chevron-down"></i></Link>
                            <ul className="submenu">
                ...
                <ul className="nav header-navbar-rht">
                    {!token ? (
                        ...
                        <li className="nav-item">
                            <button className="nav-link header-login btn btn-danger" onClick={logout}>Logout</button>
                        </li>
                    )}
                </ul>
            </nav>
